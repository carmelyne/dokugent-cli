/****
 * Timestamp-based versioning utilities used across Dokugent for
 * aliasing, folder naming, backups, and file history tracking.
 */
 ...
 *
 * @returns A string timestamp (e.g. "2025-05-15-1430")
 */
 ...
 * @returns A string with format "base@YYYY-MM-DD-HHMM"
 */
